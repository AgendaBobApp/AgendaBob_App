 ...
 */
public class PollCreationActivity extends AppCompatActivity implements
        PollCreationAdapter.ClickListener, DragSelectRecyclerViewAdapter.SelectionListener, MaterialCab.Callback {
